...
The system SHALL display a clear inline error message next to the Import link in the header when the server rejects the file or a network error occurs, without replacing the current tree.
